...
/// Convenience wrapper for the 4-public-input Shield circuit.
pub fn build_valid_shield_proof(env: &Env, public_inputs_le: [[u8; 32]; 4]) -> (Bytes, Bytes) {
    build_valid_groth16_proof(env, &public_inputs_le)
}
