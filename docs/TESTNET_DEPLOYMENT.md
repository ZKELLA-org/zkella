...
The swap-fairness circuit was rebuilt and its new proof verifies in the verifier tests. Its live `reveal_and_claim` run was recorded on the earlier stack above and has not been repeated on this one.
