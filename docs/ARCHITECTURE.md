...
AI-assisted tooling may be used to help format this document, structure its text, and design its diagrams. It is not used to generate or verify the technical claims themselves; every claim in this document is grounded in the actual contract source, test suite, or a cited, independently-verifiable Testnet transaction.
