...
- **No indexer failover.** One process, one SQLite file, no secondary instance. `docs/ARCHITECTURE.md` and `docs/POC_IMPLEMENTATION.md` describe multi-operator indexing as target architecture; it isn't built.
